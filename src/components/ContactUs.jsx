...
const AnimatedIcon = ({ icon: Icon, href, label, delay = 0 }) => (
  <motion.a
    href={href}
    className="group relative p-3 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 hover:from-blue-50 hover:to-purple-50 shadow-md hover:shadow-lg transition-all duration-300"
  ...
  >
    ...
    <Icon className="h-6 w-6 sm:h-7 sm:w-7 text-gray-600 group-hover:text-blue-600 transition-colors duration-300" />
...
const ContactUs = () => {
  const socialLinks = [
    { icon: FaInstagram, href: "https://instagram.com/ThreeNoobCoders", label: "Instagram" },
    { icon: Mail, href: "mailto:threenoobcoders@gmail.com", label: "Email" },
    { icon: FaXTwitter, href: "https://x.com/ThreeNoobCoders", label: "Twitter" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/three-noob-coders-990538324/", label: "LinkedIn" }
  ];
